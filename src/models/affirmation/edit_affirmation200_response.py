...
class EditAffirmation200Response(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["affirmation_id", "text", "playing_voice", "updated_at"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of EditAffirmation200Response from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of EditAffirmation200Response from a dict"""
        if obj is None:
            return None
