...
class ScheduleAffirmation200Response(BaseModel):
    """
    ScheduleAffirmation200Response
    """ # noqa: E501
    affirmation_id: Optional[StrictStr] = None
    schedule_config: Optional[ScheduleConfig] = None
    next_notification: Optional[datetime] = Field(default=None, description="When the next notification will be sent")
    __properties: ClassVar[List[str]] = ["affirmation_id", "schedule_config", "next_notification"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of ScheduleAffirmation200Response from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of ScheduleAffirmation200Response from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "next_notification": obj.get("next_notification")
        })
        return _obj
