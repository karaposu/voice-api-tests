...
class ScheduleAffirmationRequest(BaseModel):
    """
    ScheduleAffirmationRequest
    """ # noqa: E501
    schedule_config: ScheduleConfig
    __properties: ClassVar[List[str]] = ["schedule_config"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of ScheduleAffirmationRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of ScheduleAffirmationRequest from a dict"""
        if obj is None:
            return None
