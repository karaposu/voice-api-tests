...
# from models.get_user_profile200_response_settings import  GetUserProfile200ResponseSettings
...
class UserProfileService:
    """
    Builds a GetUserProfile200Response for the given user_id.
    The structure ( __init__  → preprocess_request_data → process_request )
    mirrors RecordsRetrieverService for consistency.
    """
    ...
    def __init__(self, request, dependencies):
        ...
        logger.debug("Inside UserProfileService")
