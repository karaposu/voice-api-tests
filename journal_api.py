...
from my_package.apis.journal_api_base import BaseJournalApi
...
from my_package.models.create_journal_entry400_response import CreateJournalEntry400Response
from my_package.models.create_journal_entry_request import CreateJournalEntryRequest
from my_package.models.export_journal_entries200_response import ExportJournalEntries200Response
from my_package.models.get_journal_analytics200_response import GetJournalAnalytics200Response
from my_package.models.get_journal_entries200_response import GetJournalEntries200Response
from my_package.models.get_journal_entries401_response import GetJournalEntries401Response
from my_package.models.get_journal_entry404_response import GetJournalEntry404Response
from my_package.models.journal_entry import JournalEntry
from my_package.models.mood_type import MoodType
from my_package.models.search_journal_entries200_response import SearchJournalEntries200Response
from my_package.models.update_journal_entry_request import UpdateJournalEntryRequest
from my_package.security_api import get_token_bearerAuth
...
async def create_journal_entry(
    ...
    if not BaseJournalApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseJournalApi.subclasses[0]().create_journal_entry(create_journal_entry_request)
...
async def delete_journal_entry(
    ...
    if not BaseJournalApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseJournalApi.subclasses[0]().delete_journal_entry(entry_id)
...
async def export_journal_entries(
    ...
    if not BaseJournalApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseJournalApi.subclasses[0]().export_journal_entries(format, date_from, date_to, include_private)
...
async def get_journal_analytics(
    ...
    if not BaseJournalApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseJournalApi.subclasses[0]().get_journal_analytics(period)
...
async def get_journal_entries(
    ...
    if not BaseJournalApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseJournalApi.subclasses[0]().get_journal_entries(limit, offset, date_from, date_to, mood, tags, search, sort_by, sort_order)
...
async def get_journal_entry(
    ...
    if not BaseJournalApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseJournalApi.subclasses[0]().get_journal_entry(entry_id)
...
async def search_journal_entries(
    ...
    if not BaseJournalApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseJournalApi.subclasses[0]().search_journal_entries(query, limit, date_range, include_ai_analysis)
...
async def update_journal_entry(
    ...
    if not BaseJournalApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseJournalApi.subclasses[0]().update_journal_entry(entry_id, update_journal_entry_request)
